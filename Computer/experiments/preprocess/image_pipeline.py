...
class Annotate(Operation):
    def __init__(self, line_finder_obj, map_x_offset, map_y_offset):
        self.type = TYPE_LINEAR
        self.line_finder_obj = line_finder_obj
        self.map = None
        self.x_offset = map_x_offset
        self.y_offset = map_y_offset
    ...
    def process(self, img):
        ...
        result[self.y_offset:self.y_offset+minimap.shape[0], self.x_offset:self.x_offset+minimap.shape[1]] = minimap
