...
#   Directory name must be "recorded".
# - A csv file for ground truth of polynomials with filename "poly.csv". 
...
def main():
    models = []
    parser = argparse.ArgumentParser(description='Test Polynomial Estimation')
